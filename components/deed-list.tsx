...
export function DeedList({ onDeedsUpdate }: DeedListProps) {
  ...
  //       }
  //       const { deeds: newDeeds, pagination: newPagination } =
  //         await getMortgageDeeds(filters);
  //       setDeeds(newDeeds);
  ...
  //     case DeedStatus.PENDING_HOUSING_COOPERATIVE_SIGNATURE:
  //       return "Waiting for Cooperative Signature";
  //     case DeedStatus.COMPLETED:
  //       return "Completed";
  //     default:
  //       return status;
  ...
  //         </SelectTrigger>
  //         <SelectContent>
  //           <SelectItem value={DeedStatus.CREATED}>Created</SelectItem>
  //           <SelectItem value={DeedStatus.PENDING_BORROWER_SIGNATURE}>
  //             Waiting for Borrower
  //           </SelectItem>
  //           <SelectItem
  //             value={DeedStatus.PENDING_HOUSING_COOPERATIVE_SIGNATURE}
  //           >
  //             Waiting for Cooperative
  //           </SelectItem>
  //           <SelectItem value={DeedStatus.COMPLETED}>Completed</SelectItem>
  //         </SelectContent>
  //       </Select>
  //       <Input
  ...
  //         onChange={(e) =>
  //           handleFilterChange("apartment_number", e.target.value)
  //         }
  //       />
  //       <Input
  ...
  //         onChange={(e) =>
  //           handleFilterChange("housing_cooperative_name", e.target.value)
  //         }
  //       />
  //     </div>
  ...
  //             )}{" "}
  //             av {pagination.totalCount} pantbrev
  //           </div>
